...
const About = () => {
  return (
    <section className="pt-40 px-6 sm:px-6 lg:px-8 bg-[#FEFEFE]">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="space-y-6 text-[#7E7E6B] leading-relaxed">
              <p className="text-lg">
                ...
                journeys. Having facilitated more than 500 therapy sessions, she
                brings both depth and dedication to her practice. Dr. Blake
                specializes in helping clients navigate anxiety, trauma, and
                relational challenges, with a strong foundation in
              ...
              <p className="text-lg">
                ...
                you&apos;re working through life transitions, emotional
                distress, or long-standing patterns, Dr. Blake meets you where
                you are with personalized strategies and a non-judgmental
                presence. Her goal is to not only help you feel better but also
              ...
              <p className="text-lg">
                ...
                the setting, she is committed to creating a safe, inclusive
                space where clients feel seen, heard, and supported. With a
                focus on authenticity and resilience, she partners with you to
                foster meaningful insight, emotional growth, and lasting change.
              </p>
            </div>
          </div>
        </div>
      </div>
      <hr className="mt-40 mb-20 mx-auto w-15/16 border-1 border-[#7E7E6B]" />
    </section>
  );
};

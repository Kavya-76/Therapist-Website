  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#94B0B0]">
      <div className="max-w-4xl mx-auto text-center">
        {/* Section Header */}
        <h2 className="text-4xl sm:text-5xl font-light text-[#41413F] mb-16">
          Rates and Insurance
        </h2>
        ...
        <div className="space-y-12 text-[#41413F]">
          ...
          {/* Office Hours */}
          <div className="mt-16">
            <h3 className="text-3xl font-light text-[#41413F] mb-8">
              Office Hours
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              {/* In-person */}
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <h4 className="text-xl font-medium text-[#41413F] mb-4">
                  In-Person
                </h4>
                <p className="text-lg text-[#41413F]">
                  Tuesday & Thursday
                </p>
                <p className="text-lg text-[#41413F]">
                  10 AM – 6 PM
